  ...
  return (
    <main className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {stats.map((stat) => (
          <article key={stat.label} className="rounded-xl border border-slate-900/15 bg-slate-50/70 px-4 py-3">
            <p className="text-xs uppercase tracking-[0.16em] text-slate-900/60">{stat.label}</p>
