...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-linear-to-b from-slate-50 to-slate-100 p-4">
        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          <label className="block text-sm text-slate-950">
            ...
            <input
              ...
              type="email"
              required
              className="mt-1 w-full rounded-xl border border-slate-900/20 bg-white px-3 py-2"
            />
          </label>
